...
Ho-Kyun Lee, CEO of Sensor9 Co., Ltd.`,
  ...
  slide3TitleKR: '-270℃ 극저온부터 1370℃ 초고온까지 완벽 대응\n가혹한 가열로 환경을 위한 초고속 반응 K-TYPE 온도 센서',
  slide3TitleEN: 'Flawlessly responding from -270°C cryogenic to 1370°C ultra-high temperatures, the ultra-fast response K-TYPE temperature sensor is built for harsh heating furnace environments.',
  slide3SeriesKR: '초고속 반응 K-TYPE 및 고온 전주 센서 SN-KTYPE Series',
  slide3SeriesEN: 'Heavy Industrial K-Type Probe (SN-KTYPE Series)',
  slide3DescKR: 'K-TYPE은 광범위한 온도 측정 영역을 자랑합니다. 특수 세라믹 격막과 하스텔로이 보호 공법을 적용하여, 가열로 내벽의 초고온 화염과 가혹한 부식 환경에서도 산화를 극소화하고 최고의 내구성을 유지합니다.',
  ...
  slide4TitleKR: '찌꺼기가 쌓여도 오작동 없는 정확함\n오일·혼합액 맞춤형 고정밀 수위 감지 센서',
  slide4TitleEN: 'Accurate detection with zero false alarms even with residue buildup\nHigh-precision water level sensors customized for oil and mixed liquids',
  slide4SeriesKR: '수위 감지 및 산업 현장의 사고를 막는 누수/유출 방지 센서',
  slide4SeriesEN: 'Water level sensing and leak/spill prevention sensors preventing industrial accidents',
  slide4DescKR: '진보한 광전 센싱 기술과 다중 전극 감도 제어로 오일, 물, 세정액이 섞인 복잡한 환경에서도 침전물로 인한 오류 없이 정확한 수위 및 유출을 감지합니다.',
  slide4DescEN: 'With advanced photoelectric sensing technology and multi-electrode sensitivity control, it accurately detects water level and leakage without errors caused by sediments even in complex environments containing mixtures of oil, water, and washing liquid.',
